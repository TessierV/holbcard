...
function generateCards(cardData) {
    ...
    cardData.forEach(card => {
        ...
        titleElement.classList.add('py-3', 'px-5', 'text-xs', 'uppercase', 'tracking-wide', 'mx-4', 'w-min-content','self-end', 'rounded-full', 'font-bold', 'bg-black', 'text-white', 'leading-5', 'relative', 'z-10', 'justify-end');
